...
class WpProQuiz_View_FrontQuiz extends WpProQuiz_View_View {
	...
	public function show($preview = false) {
		...
		<div class="wpProQuiz_content" id="wpProQuiz_<?php echo $this->quiz->getId(); ?>">
			<div class="wpProQuiz_spinner" style="display:none"><div></div></div>
		<?php 
...
<?php 
	...
	private function showLockBox() {
		...
		<div style="display: none;" class="wpProQuiz_lock">
			<p>
				<?php _e('You have already completed the quiz before. Hence you can not start it again.', 'learndash'); ?>
			</p>
		</div>
		<?php 
	}
	...
	?>
		<div style="display: none;" class="wpProQuiz_sending">
			...
			<p>
				<div><?php _e("Quiz complete. Results are being recorded.", "learndash"); ?></div>
				<div><dd class="course_progress">
		...
		<div style="display: none;" class="wpProQuiz_results">
			<h4 class="wpProQuiz_header"><?php _e('Results', 'wp-pro-quiz'); ?></h4>
				...
				<?php } ?>
				<p class="wpProQuiz_certificate"  style="display: none !important;" >
...
<!--				<div class='quiz_continue_link'  style="margin: 10px 0px;">
					...
					<div class='___quiz_continue_link_'  style="margin: 20px 0px;">
						<a href="<?php echo site_url(); ?>/knowledge-centre/" id="quiz_continue_link">Click Here to Continue </a>
					</div>						
				</div>
			</div>
	<?php 
	...
	?>
		<div style="display: none;" class="wpProQuiz_loadQuiz">
			<p>
				<?php _e('Quiz is loading...', 'learndash'); ?>
			</p>
		</div>
	<?php 
	}
